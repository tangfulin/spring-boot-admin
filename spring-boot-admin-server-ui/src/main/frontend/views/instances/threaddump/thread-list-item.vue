<template>
  <table class="table-auto table-wide table-striped w-full my-2 border shadow bg-white">
    <colgroup>
      <col class="w-60">
    </colgroup>
    <tr>
    ...
    <template v-if="details !== null">
      ...
      <tr>
        <td class="label" v-text="$t('instances.threaddump.thread_details_blocked_count')" />
        <td v-text="details.blockedCount" />
      </tr>
      <tr>
        <td class="label" v-text="$t('instances.threaddump.thread_details_blocked_time')" />
        <td v-text="details.blockedTime" />
      </tr>
      <tr>
        <td class="label" v-text="$t('instances.threaddump.thread_details_waited_count')" />
        <td v-text="details.waitedCount" />
      </tr>
      <tr>
        <td class="label" v-text="$t('instances.threaddump.thread_details_waited_time')" />
        <td v-text="details.waitedTime" />
      </tr>
      <tr>
        <td class="label" v-text="$t('instances.threaddump.thread_details_lock_name')" />
        <td v-text="details.lockName" />
      </tr>
      <tr>
        <td class="label" v-text="$t('instances.threaddump.thread_details_lock_owner_id')" />
        <td v-text="details.lockOwnerId" />
      </tr>
      <tr>
        <td class="label" v-text="$t('instances.threaddump.thread_details_lock_owner_name')" />
