...
<template>
  <div>
    ...
    <div
      class="application-list-item card bg-white px-4 py-3"
...
import ApplicationSummary from './applications-list-item-summary.vue';
...
export default {
  components: {ApplicationListItemActions, ApplicationSummary, InstancesList},
  props: {
    application: {
      type: Application,
      required: true
