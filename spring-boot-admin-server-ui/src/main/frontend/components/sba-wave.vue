  ...
  >
    ...
    >
      ...
      <path
        ...
        style="isolation:isolate;opacity:0.4000000059604645"
        :style="`fill:url(#a${id})`"
      />
      <path
        d="M0,0V152.67q200,64.5,400,29.5a1115.6,1115.6,0,0,1,400,2.4q200,37.35,400,19.1a3681.66,3681.66,0,0,1,400-14.6q200,3.6,400-45.5V0Z"
        style="isolation:isolate;opacity:0.4000000059604645"
        :style="`fill:url(#b${id})`"
      />
      <path
